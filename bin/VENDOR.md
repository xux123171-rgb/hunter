...
| 二进制 | 上游项目 | 版本 | 构建方式 |
|---|---|---|---|
| `ffuf.exe` | github.com/ffuf/ffuf | v2.1 | `go install github.com/ffuf/ffuf/v2@latest` |
...
## 我们的自研（可整份带走）
`hunter` 方法论 + SOP + 影响/合规门 + 自研工具（hunter-cli/mailacct/xssprobe）+ 模板 + 编排 = 100% 我们写的，
不依赖任何第三方代码即可读懂方法论；第三方引擎只是底层可替换依赖。
